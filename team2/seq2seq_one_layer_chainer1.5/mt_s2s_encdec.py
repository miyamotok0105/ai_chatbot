...
def parse_args():
  ...
  p.add_argument('--model-save-timing', default=def_model_save_timing, metavar='INT', type=int,
  ...
  try:
    ...
    if args.model_save_timing < 1: raise ValueError('you must set --model-save-timing >= 1')
