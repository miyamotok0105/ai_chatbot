...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch'    , dest='epoch'      , type=int, default=1,          help='number of epochs to learn')
    ...
    x_train, y_train, c_train, word_train = (dataset['source'], dataset['target'], dataset['comment'], dataset['word'])
    ...
    for epoch in six.moves.range(1, n_epoch + 1):
        ...
        # training---------------------------------------------
        perm = np.arange(N) #整数列リストを取得
        sum_train_loss     = 0.0
        sum_train_accuracy = 0.0
        for i in six.moves.range(0, N, batchsize):
            # print("i",perm[i:i+batchsize])
            # print("x_train",x_train)
            ...
            print('train mean loss={}, accuracy={},class={}'.format(sum_train_loss, sum_train_accuracy,np.argmax(y)))
