...
mlp = mlp.fit( train_data_features, train["label"] )

print('accuracy on the training set: %f' %mlp.score( train_data_features, train["label"] ))
...
result = mlp.predict(test_data_features)
